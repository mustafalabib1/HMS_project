...
namespace DALProject.Data.Migrations
{
    ...
    [Migration("20241011121512_AddDeleteActiveSubstanceProcedure")]
    partial class AddDeleteActiveSubstanceProcedure
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DALProject.model.Apointment", b =>
                {
                    ...
                    b.HasIndex("PrescriptionId1")
                        .IsUnique()
                        .HasFilter("[PrescriptionId1] IS NOT NULL");
            ...
            modelBuilder.Entity("DALProject.model.Apointment", b =>
                {
                    ...
                    b.HasOne("DALProject.model.Prescription", null)
                        .WithOne("Apointment")
                        .HasForeignKey("DALProject.model.Apointment", "PrescriptionId1");
